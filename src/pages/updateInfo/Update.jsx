...
const Update = () => {
  ...
  const total = parseInt(food.quantity);
  ...
  const handleUploadFood = (e) => {
    ...
    fetch(`https://chicken-hub-server.onrender.com/all-foods/${food._id}`, {
      method: "PUT",
      headers: {
  ...
  if (loading) {
    return (
      <div className="flex justify-center min-h-screen items-center py-40">
      ...
      <div className="add_food_banner w-full py-20 lg:py-32 relative">
        <div className="container mx-auto px-4">
          <div className="flex items-center gap-1">
            ...
            <p className="text-secondary">Update</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            <div>
              <h2 className="text-primary font-medium text-[24px] lg:text-[30px] mb-5">
                You Can Update Your Food Details
              </h2>
