...
const ExpiredFood = () => {
  ...
  useEffect(() => {
    document.title = "Chicken-Hub | Expired Food";
    axios
  ...
  const filterdData = data?.filter((res) => res.expireDate < currentDate);

  const filteredFoods = filterdData?.filter((food) => {
      ...
      <div className="my_items_banner w-full py-20 lg:py-44 relative">
        <div className="container mx-auto px-4">
          <div className="flex items-center gap-1">
            ...
            <p className="text-secondary">Expired Food</p>
          </div>
